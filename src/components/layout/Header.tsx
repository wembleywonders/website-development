...
const Header: React.FC = () => {
  ...
  const handleMayaClick = () => {
    toggleVisitorGuide();
    window.dispatchEvent(new CustomEvent('maya:open', { detail: { source: 'header' } }));
  };
        ...
        <div className="top-bar-container">
          <div className="top-bar-left">
            <Link to="/" className="logo-link" onClick={closeMenu}>
              <img src="/logo.png" alt="Wembley Wonders" className="logo-img"
                onError={(e) => {
          ...
          <div className="top-bar-right">
            <button className={`maya-button ${isVisitorGuideActive ? 'active' : ''}`}
              onClick={handleMayaClick} aria-label="Ask Maya AI Assistant">
            ...
            <div className="account-section"
              ...
              {activeDropdown === 'account' && isLoggedIn && (
                <div className="account-dropdown">
                  <Link to="/dashboard" className="dropdown-link" onClick={closeMenu}><span className="link-icon">🎨</span>My Workspace</Link>
                  <Link to="/creators-journal" className="dropdown-link" onClick={closeMenu}><span className="link-icon">📔</span>Creator's Journal</Link>
                  <Link to="/dashboard" className="dropdown-link" onClick={closeMenu}><span className="link-icon">📊</span>Dashboard</Link>
                  <div className="dropdown-divider"></div>
                  <Link to="/dashboard" className="dropdown-link" onClick={closeMenu}><span className="link-icon">⚙️</span>Settings</Link>
                  <button className="dropdown-link logout" onClick={() => { console.log('Logout clicked'); closeMenu(); }}><span className="link-icon">🚪</span>Logout</button>
                </div>
              )}
            </div>
          </div>

          <button className={`mobile-menu-toggle ${isMenuOpen ? 'open' : ''}`}
            onClick={toggleMenu} aria-label="Toggle mobile menu" aria-expanded={isMenuOpen}>
        ...
        <div className="main-nav-container">
          <ul className="nav-list">
            ...
            <li className="nav-item nav-primary">
              <Link to="/sandbox" className={`nav-link nav-cta ${isActive('/sandbox') ? 'active' : ''}`} onClick={closeMenu}>
                <span className="nav-icon">🎨</span><span>Try It</span>
              </Link>
            </li>
            ...
            <li className="nav-item nav-dropdown"
              ...
              <button className="nav-link">
                <span className="nav-icon">📅</span><span>What's On</span><span className="nav-arrow">▼</span>
              </button>
              {activeDropdown === 'whats-on' && (
                <div className="nav-dropdown-menu">
                  {/* ✨ IWD 2026 — time-limited featured item, remove after 31 March 2026 */}
                  <Link to="/editorial/iwd-2026" className="dropdown-item featured iwd-featured" onClick={closeMenu}>
                    <span className="item-icon">✊🏿</span>
                    <div className="item-content">
                      <strong>Women's Voices — IWD 2026</strong>
                      <span className="item-subtitle">Community responses to International Women's Day</span>
                    </div>
                  ...
                  <div className="dropdown-divider"></div>
                  <Link to="/raydyo" className="dropdown-item featured" onClick={closeMenu}><span className="item-icon">📻</span><div className="item-content"><strong>Rayd-yo Live</strong><span className="item-subtitle">Community radio</span></div></Link>
                </div>
              )}
            </li>
            ...
            <li className="nav-item nav-dropdown"
              ...
              onMouseLeave={() => setActiveDropdown(null)}>
              <button className="nav-link">
                <span className="nav-icon">🚀</span><span>Creator Spaces</span><span className="nav-arrow">▼</span>
              </button>
              {activeDropdown === 'creator-spaces' && (
                <div className="nav-dropdown-menu nav-dropdown-wide">
                  <Link to="/creator-factory" className="dropdown-item featured factory-featured" onClick={closeMenu}>
                    <span className="item-icon">🏭</span>
                    <div className="item-content"><strong>The Creator Factory</strong><span className="item-subtitle">Ideas go in. Income comes out. See the full pipeline.</span></div>
                    <span className="new-badge">NEW</span>
                  </Link>
                  <Link to="/programmes/bright-sparks" className="dropdown-item bright-sparks-featured" onClick={closeMenu}>
                    <span className="item-icon">✨</span>
                    <div className="item-content"><strong>Bright Sparks</strong><span className="item-subtitle">Not sure where to start? Begin here.</span></div>
                  </Link>
                  {/* ✨ CHANGE 2: Find your earning path — passes pathway intent to Maya */}
                  <Link
                    to="/creator-pathways"
                    state={{ mayaIntent: 'pathway' }}
                    className="dropdown-item pathway-featured"
                    onClick={closeMenu}
                  >
                    <span className="item-icon">🗺️</span>
                    <div className="item-content">
                      <strong>Find your earning path</strong>
                      <span className="item-subtitle">Match your skills to a real income route</span>
                    </div>
                  </Link>
                  <div className="dropdown-divider"></div>
                  <div className="dropdown-grid">
                    ...
                    {/* ✨ Easy Street */}
                    <Link to="/programmes/easy-street" className="dropdown-item compact" onClick={closeMenu}><span className="item-icon">📻</span><strong>Easy Street</strong></Link>
                    ...
                    {/* Roots — coming-soon badge removed, IWD has passed */}
                    <Link to="/programmes/roots" className="dropdown-item compact roots-nav" onClick={closeMenu}>
                      <span className="item-icon">🌿</span>
                      <strong>Roots</strong>
                    </Link>
                  </div>
                  ...
                  <div className="dropdown-footer-links">
                    ...
                    {/* ✨ CHANGE 1: label updated from "Creator Pathways (Classic) →", state passes pathway intent */}
                    <Link
                      to="/creator-pathways"
                      state={{ mayaIntent: 'pathway' }}
                      className="dropdown-item view-all secondary"
                      onClick={closeMenu}
                    >
            ...
            <li className="nav-item nav-dropdown"
              ...
              <button className={`nav-link ${isActive('/workshops/spark-generator') || isActive('/workshops/facilitation') ? 'active' : ''}`}>
                <span className="nav-icon">⚡</span><span>Facilitator Tools</span><span className="nav-arrow">▼</span>
              </button>
            ...
            <li className="nav-item nav-dropdown"
              ...
              onMouseLeave={() => setActiveDropdown(null)}>
              <button className="nav-link">
                <span className="nav-icon">👥</span><span>Who We Are</span><span className="nav-arrow">▼</span>
              </button>
              {activeDropdown === 'who-we-are' && (
                <div className="nav-dropdown-menu">
                  ...
                  <Link to="/impact" className="dropdown-item" onClick={closeMenu}><span className="item-icon">📊</span><div className="item-content"><strong>Our Impact</strong><span className="item-subtitle">What we've achieved together</span></div></Link>
                  <div className="dropdown-divider"></div>
            ...
            <li className="nav-item">
              <Link to="/shop" className={`nav-link nav-shop ${isActive('/shop') ? 'active' : ''}`} onClick={closeMenu}>
                <span className="nav-icon">🛒</span><span>Shop</span>
              </Link>
            </li>
      ...
      <div className={`mobile-nav ${isMenuOpen ? 'open' : ''}`}>
        <div className="mobile-nav-content">
          <div className="mobile-cta-section">
            <Link to="/sandbox" className="mobile-cta-button" onClick={closeMenu}>🎨 Try It Now — No Signup Needed</Link>
          </div>
          <div className="mobile-quick-section">
            <button className={`mobile-maya-btn ${isVisitorGuideActive ? 'active' : ''}`}
              onClick={() => { handleMayaClick(); closeMenu(); }}>
          ...
          <div className="mobile-account-section">
            ...
            {isLoggedIn ? (
              <>
                <Link to="/dashboard" className="mobile-nav-link" onClick={closeMenu}>🎨 My Workspace</Link>
                ...
                <Link to="/dashboard" className="mobile-nav-link" onClick={closeMenu}>⚙️ Settings</Link>
                <button className="mobile-nav-link logout" onClick={closeMenu}>🚪 Logout</button>
              </>
            ) : (
            ...
            <div className="mobile-expandable">
              ...
              {activeDropdown === 'mobile-whats-on' && (
                <div className="mobile-submenu">
                  {/* ✨ IWD 2026 — remove after 31 March 2026 */}
            ...
            <div className="mobile-expandable">
              ...
              {activeDropdown === 'mobile-spaces' && (
                <div className="mobile-submenu">
                  ...
                  {/* ✨ CHANGE 2 (mobile): Find your earning path — passes pathway intent to Maya */}
                  <Link
                    to="/creator-pathways"
                    state={{ mayaIntent: 'pathway' }}
                    className="mobile-nav-link sub featured pathway"
                    onClick={closeMenu}
                  >
                    🗺️ Find your earning path
                  </Link>
                  <div className="mobile-submenu-divider"></div>
                  ...
                  {/* ✨ Easy Street */}
                  <Link to="/programmes/easy-street" className="mobile-nav-link sub" onClick={closeMenu}>📻 Easy Street</Link>
                  ...
                  {/* Roots — coming-soon badge removed */}
                  ...
                  {/* ✨ CHANGE 1 (mobile): label updated, state passes pathway intent */}
                  <Link
                    to="/creator-pathways"
                    state={{ mayaIntent: 'pathway' }}
                    className="mobile-nav-link sub view-all secondary"
                    onClick={closeMenu}
                  >
                    Find your earning path →
                  </Link>
